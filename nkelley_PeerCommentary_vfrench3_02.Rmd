...
V: Include the prompt in the script? It would better rationalize where you are getting your parameters from. 
...
3. Overall the code is neat/organized and generating correct output (or at least the same as mine haha) so great job! 